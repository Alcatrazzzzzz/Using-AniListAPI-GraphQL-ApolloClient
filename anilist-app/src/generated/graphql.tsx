...
export type GetAnimePageQueryVariables = Exact<{
  ...
  type?: Maybe<MediaType>;
  format_in?: Maybe<Array<Maybe<MediaFormat>> | Maybe<MediaFormat>>;
}>;

export type GetAnimePageQuery = { __typename?: "Query" } & {
  Page?: Maybe<
    { __typename?: "Page" } & {
      pageInfo?: Maybe<
            ...
            > & {
                ...
                studios?: Maybe<
                  { __typename?: "StudioConnection" } & {
                    nodes?: Maybe<
                      Array<
                        Maybe<{ __typename?: "Studio" } & Pick<Studio, "name">>
                      >
                    >;
                  }
                >;
 ...
 *      sort: // value for 'sort'
 *      type: // value for 'type'
 *      format_in: // value for 'format_in'
 *   },
 * });
 */
export function useGetAnimePageQuery(
  ...
  return Apollo.useQuery<GetAnimePageQuery, GetAnimePageQueryVariables>(
    GetAnimePageDocument,
    options
  );
}
export function useGetAnimePageLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAnimePageQuery, GetAnimePageQueryVariables>(
    GetAnimePageDocument,
    options
  );
}
export type GetAnimePageQueryHookResult = ReturnType<
  typeof useGetAnimePageQuery
>;
export type GetAnimePageLazyQueryHookResult = ReturnType<
  typeof useGetAnimePageLazyQuery
>;
export type GetAnimePageQueryResult = Apollo.QueryResult<
  GetAnimePageQuery,
  GetAnimePageQueryVariables
>;
