...
export type GetAnimePageQuery = (
  ...
  & { Page?: Maybe<(
    ...
    & { pageInfo?: Maybe<(
      { __typename?: 'PageInfo' }
      & Pick<PageInfo, 'total' | 'currentPage' | 'lastPage' | 'hasNextPage' | 'perPage'>
    )>, media?: Maybe<Array<Maybe<(
      { __typename?: 'Media' }
      & Pick<Media, 'id' | 'genres' | 'averageScore' | 'episodes' | 'format' | 'season'>
      & { title?: Maybe<(
        { __typename?: 'MediaTitle' }
...
export const GetAnimePageDocument = gql`
    query getAnimePage($id: Int, $page: Int, $perPage: Int, $search: String, $season: MediaSeason, $seasonYear: Int, $sort: [MediaSort], $type: MediaType) {
